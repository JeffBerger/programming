<?php include "header.php";?>
    ...
    <div class="container">
      ...
      <div class="jumbotron">
        ...
        <hr/>
        <h2>New Tutorials</h2>
        <p>Finally the first one on actual programming is up with the first <a href="js1.php">javascript tutorial</a> done in my own style.  This is very long but goes over a lot of basic programming knowledge as well if you haven't been exposed to it.</p>
        <p>I've also added prereqs onto the beginning of every tutorial thus far.</p>
        <hr/>
